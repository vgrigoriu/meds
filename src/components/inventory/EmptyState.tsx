  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
      ...
      <h3 className="font-heading text-xl font-semibold text-slate-900 dark:text-slate-100 mb-2">
        Dulapul de medicamente este gol
      </h3>
      <p className="text-slate-500 dark:text-slate-400 mb-6 max-w-sm">
        Începe să îți urmărești medicamentele adăugând primul articol. Nu vei mai pierde niciodată din vedere datele de expirare.
      </p>
